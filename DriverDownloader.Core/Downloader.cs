...
using DriverDownloader.Core.Concurrency;
...
namespace DriverDownloader.Core
{
    ...
    public class Downloader
    {
        ...
        private int extractedCompleteIndex;
        private int progressbarSegment;
        ...
        protected IProtocolProvider defaultDownloadProvider;
        ...
        public int ExtractedCompletedIndex
        {
            get { return this.extractedCompleteIndex; }
            set { this.extractedCompleteIndex = value; }
        }
            ...
            this(rl, mirrors, localFile)
        {
            ...
            this.progressbarSegment = 1;
            this.segments = new List<Segment>();

            this.extractedCompleteIndex = completedIndex;
        }
        public Downloader(
            ResourceLocation rl,
            ResourceLocation[] mirrors,
        ...
        private void StartToPrepare()
        {
            ...
            mainThread.Start(progressbarSegment);
        }
        ...
        private void AllocLocalFile()
        {
            ...
            using (fs = new FileStream(this.LocalFile, FileMode.OpenOrCreate, FileAccess.Write))
            {
                Console.WriteLine("Creating FileStream with length: " + this.FileSize + " FileName: "+this.localFile);
        ...
        // Called when downloads restart upon application launch
        ...
        private void RunSegments()
        {
            ...
            using (fs = new FileStream(this.LocalFile, FileMode.Open, FileAccess.Write))
            {
                Console.WriteLine("Downloading file: " + this.localFile);
            ...
            //DEBUGGING (uncomment the line above and comment the line below; for the application to work normally)
            //SetState(DownloaderState.EndedWithError);
            // SetState(DownloaderState.EndedWithError);
        }
